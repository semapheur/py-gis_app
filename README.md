...
The packaged application will be generated in the `dist` directory at the root of the project. To start the application run `app.py` from inside the `dist` directory.
